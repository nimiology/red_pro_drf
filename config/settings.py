...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='red_db'),
...
STATIC_URL = '/static/'
STATIC_ROOT = config('STATIC_ROOT', default=os.path.join(BASE_DIR, "static_cdn", "static_root"))

MEDIA_URL = '/media/'
MEDIA_ROOT = config('MEDIA_ROOT', default=os.path.join(BASE_DIR, "static_cdn", "media_root"))
